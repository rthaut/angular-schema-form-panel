angular.module('templates', []).run(['$templateCache', function($templateCache) {$templateCache.put('src/templates/angular-schema-form-panel-group.html','<div class="panel-group schema-form-panel-group {{::form.groupClass}}" ng-init="groupId = $id" id="PanelGroup{{groupId}}" role="tablist" aria-multiselectable="false"></div>\n');
